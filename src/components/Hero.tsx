        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 mb-8 px-5 py-2.5 bg-primary/10 border border-primary/20 rounded-full"
            >
              <Sparkles className="w-4 h-4 text-primary" />
              <span className="text-primary font-medium text-sm">Building Digital Excellence</span>
            </motion.div>
            
            {/* Headline */}
            <motion.h1 
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold mb-8 leading-[1.1] tracking-tight"
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">5.0 Rated Agency</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
